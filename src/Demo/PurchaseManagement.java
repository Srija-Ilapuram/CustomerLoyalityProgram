...
//
//            String query = "INSERT INTO Purchase (customer_id, amount, date) VALUES (?, ?, CURRENT_DATE)";
//            PreparedStatement pstmt = conn.prepareStatement(query);
//            pstmt.setInt(1, customerId);
...
//                System.out.println("Purchase added successfully.");
//
//                String updatePointsQuery = "UPDATE Customer SET total_points = total_points + ? WHERE customer_id = ?";
//                PreparedStatement updatePointsStmt = conn.prepareStatement(updatePointsQuery);
//                updatePointsStmt.setInt(1, (int) amount);  // Assuming 1 point per dollar spent
//                updatePointsStmt.setInt(2, customerId);
...
//            double amount = scanner.nextDouble();
//
//            String query = "UPDATE Purchase SET amount = ? WHERE purchase_id = ?";
//            PreparedStatement pstmt = conn.prepareStatement(query);
